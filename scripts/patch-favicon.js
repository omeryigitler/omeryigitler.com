...
if (!html.includes(faviconBlock)) {
  if (!html.includes(legacyFavicon)) {
    throw new Error("Could not find the legacy favicon link in index.html");
  }
...
const structuredLogo = '      "logo": "https://omeryigitler.com/icon-512.png",\n';
...
if (changed) {
  ...
  console.log("Patched favicon, app-icon and structured-data metadata in index.html");
} else {
  console.log("Favicon metadata is already up to date");
}
