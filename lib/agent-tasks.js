...
const PANEL_GUIDE = [
  ...
  "PROPOSALS (Quotes): teklif listesi. Filtreler: all / draft / sent / accepted. Kısımlar: toplu silme, mesajdan teklif oluşturma, PDF üretme (sunucuda /api/pdf), gönderme. Akış: draft → sent → accepted. Numaralar Q-YYYY-NNN; agent onayıyla oluşanlar QA-YYYY-XXXX.",
  "PROJECTS (Project Matrix): proje kartları. Filtreler: active / completed. Kısımlar: proje oluşturma/düzenleme modali, iş akışı aşamaları lead → proposal → active → review → approved, ilerleme yüzdesi, bütçe + para birimi, başlangıç/teslim tarihi, bağlı teklif/mesaj, Studio çalışma alanı, otomatik pipeline seçeneği.",
  "CLIENTS (Client Management): müşteri listesi (mesaj/teklif/proje sayılarıyla), toplu silme, müşteri detayında geçmiş: mesajları, teklifleri, projeleri. Müşteriler mesajlardan otomatik oluşur.",
