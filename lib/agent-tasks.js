...
const PANEL_GUIDE = [
  ...
  "PROJECTS: proje kartları (başlık, durum rozeti, müşteri, aşama + ilerleme çubuğu, bütçe, teslim tarihi). Filtreler: Active / Archived; 'New Project' butonu. Kart tıklanınca proje penceresi açılır; sekmeleri: Overview (müşteri + proje bilgisi + workflow onayı + notlar), Brief (brief/hedef/kitle/referans/sitemap/içerik notları + asset checklist), Budget (maliyet dökümü), Roadmap (aşamalar), Files (dosyalar). İş akışı aşamaları lead → proposal → active → review → approved.",
