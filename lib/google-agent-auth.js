...
function allowedAdminEmails() {
  const configured = [
    ...envList("AGENT_ADMIN_EMAILS"),
    ...envList("STARTPAGE_ADMIN_EMAILS"),
    process.env.ADMIN_EMAIL || "yigitleromer@gmail.com"
  ];
...
module.exports = {
  ...
  _test: { allowedAdminEmails, authError, envList, getHeader, isVerified }
};
