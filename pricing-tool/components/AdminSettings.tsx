      ...
      <div className={`flex justify-between items-center bg-black p-3 rounded-lg border border-zinc-800 hover:border-zinc-700 transition-colors ${className}`}>
         ...
         <div className="flex items-center space-x-2 flex-shrink-0">
            ...
            <input 
              ...
              className="bg-zinc-900 border border-zinc-700 rounded px-3 py-2 text-white w-24 text-right focus:border-[#FFD700] outline-none text-sm font-bold"
            />
         </div>
      </div>
    );
    ...
    <div className="max-w-7xl mx-auto px-4 py-12">
      <div className="flex justify-between items-center mb-8">
        ...
        <div className="flex space-x-3">
          ...
          <button onClick={handleSave} className="flex items-center px-6 py-2 bg-[#FFD700] text-black font-bold rounded-lg hover:bg-[#FFD700] transition-colors shadow-lg shadow-taurusGold/20">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
        ...
        <div className="space-y-8">
            ...
            <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-6">
              <h2 className="text-xl font-bold text-white mb-6 flex items-center">
                <Globe className="w-5 h-5 mr-2 text-[#FFD700]" /> {t.basePrices} ({rules.currencySymbol})
              </h2>
            ...
            <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-6">
              <h2 className="text-xl font-bold text-white mb-6 flex items-center">
                 <RotateCcw className="w-5 h-5 mr-2 text-[#FFD700]" /> {t.maintenanceRates}
              </h2>
              <div className="space-y-3">
        ...
        <div className="space-y-8">
            ...
            <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-6">
              <h2 className="text-xl font-bold text-white mb-6 flex items-center">
                <Settings className="w-5 h-5 mr-2 text-[#FFD700]" /> {t.unitRates}
              </h2>
              <div className="space-y-3">
                 <UniversalInputRow 
                    label={t.pageRate} 
               ...
               <div className="border-t border-zinc-800 mt-6 pt-6">
                  <h3 className="text-lg font-bold text-white mb-4 flex items-center">
                     <Zap className="w-5 h-5 mr-2 text-[#FFD700]" /> {t.speedMultipliers} (x)
                  </h3>
                  <div className="space-y-3">
                      ...
                      <div key={key} className="flex justify-between items-center bg-black p-3 rounded-lg border border-zinc-800 hover:border-zinc-700 transition-colors">
                        ...
                        <div className="relative">
                          <input 
                            ...
                            className="bg-zinc-900 border border-zinc-700 rounded px-3 py-2 text-white w-24 text-right focus:border-[#FFD700] outline-none font-bold"
                          />
            ...
            <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-6">
              <h2 className="text-xl font-bold text-white mb-4 flex items-center">
                 <Percent className="w-5 h-5 mr-2 text-[#FFD700]" /> {t.multipliers}
              </h2>
      ...
      <div className="mt-8 bg-zinc-900 border border-zinc-800 rounded-2xl p-6">
        <div className="flex justify-between items-center mb-6">
           <h2 className="text-xl font-bold text-white flex items-center">
             <Package className="w-5 h-5 mr-2 text-[#FFD700]" /> {t.addonsTitle}
           </h2>
           <button 
             onClick={() => {
                ...
                <div key={addon.id} className="grid grid-cols-1 md:grid-cols-12 gap-4 items-end bg-black p-4 rounded-xl border border-zinc-800 hover:border-zinc-700 transition-colors">
                   <div className="md:col-span-3">
                     ...
                     <input 
                        ...
                        className="w-full bg-zinc-900 border border-zinc-700 rounded px-3 py-2 text-white text-sm focus:border-[#FFD700] outline-none h-[42px]"
                     />
                   </div>
                   <div className="md:col-span-6">
                     ...
                     <input 
                        ...
                        className="w-full bg-zinc-900 border border-zinc-700 rounded px-3 py-2 text-zinc-300 text-sm focus:border-[#FFD700] outline-none h-[42px]"
                     />
                   </div>
                   ...
                   <div className="md:col-span-2">
                     ...
                     <div className="flex items-center space-x-2 bg-zinc-900 border border-zinc-700 rounded px-2 h-[42px] focus-within:border-[#FFD700] transition-colors">
                        {/* Type Toggles */}
