  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-24 sm:px-6 lg:px-8">
      ...
      <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 max-w-5xl mx-auto">
        ...
        <div 
          onClick={() => onNavigate('calculator')}
          className="group relative bg-zinc-900/50 backdrop-blur-sm p-10 rounded-3xl border border-zinc-800 hover:border-yellow-500/50 transition-all duration-300 cursor-pointer overflow-hidden"
        >
          ...
          <div className="absolute top-0 right-0 p-6 opacity-50 group-hover:opacity-100 transition-opacity">
            <ArrowRight className="w-6 h-6 text-yellow-400 -rotate-45 group-hover:rotate-0 transition-transform duration-300" />
          </div>
          <div className="mb-8 relative z-10">
            <span className="inline-flex p-4 bg-zinc-800 text-yellow-400 rounded-2xl ring-1 ring-zinc-700 group-hover:bg-yellow-400 group-hover:text-black transition-colors duration-300">
